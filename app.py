...
# 페이지 설정
st.set_page_config(page_title="부동산 신축 분석기 v5.4 (무적모드)", layout="wide")

st.title("🏗️ 부동산 신축 사업성 분석기 v5.4")
st.markdown("---")

# --- 좀비 접속기(Session) 만들기 ---
# 연결이 끊겨도 3번까지 다시 시도하는 설정
...
st.sidebar.markdown("---")
st.sidebar.info("💡 팁: 주소 검색이 계속 안 되면 '수동 입력' 탭을 쓰세요.")
...
with tab2:
    ...
    st.markdown("[PNU 코드 찾는 법](http://www.kras.go.kr:444/cmm/main/mainPage.do) : 부동산종합공부시스템 등에서 확인 가능")
